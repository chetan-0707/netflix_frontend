      ...
      <img className='w-56' src='https://images.ctfassets.net/y2ske730sjqp/6bhPChRFLRxc17sR8jgKbe/6fa1c6e6f37acdc97ff635cf16ba6fb3/Logos-Readability-Netflix-logo.png' alt='netflix-logo' />
      {
        user && (
          <div className='flex items-center'>
            ...
            <div className='ml-4'>
              <button onClick={logoutHandler} className='bg-red-700 text-white px-4 py2'>Logout</button>
              <button onClick={toggleHandler} className='bg-red-700 text-white px-4 py2 ml-2'>{toggle ? "Home":'Search Movie'}</button>
            </div>
          </div>
        )
      }
